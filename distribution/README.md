...
The image is currently shipping with the Open Data Hub version of OGX version [1.2.2+rhaiv.0](https://github.com/opendatahub-io/ogx/releases/tag/v1.2.2+rhaiv.0)
